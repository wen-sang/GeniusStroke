...
from utils.decimal_utils import floor_to_int_qty, quantize_amount, quantize_qty, to_decimal
...
def build_preview(
    ...
    return {
        "eligible_qty": quantize_qty(eligible_qty),
        "affected_lot_count": affected_lot_count,
        "split_ratio_text": split_ratio_text,
        "dividend_cash": quantize_amount(dividend_cash),
        "reinvest_volume": quantize_qty(reinvest_volume),
        "dividend_cash_used": quantize_amount(dividend_cash_used),
        "cash_residual": quantize_amount(cash_residual),
        "warnings": warnings,
    }
